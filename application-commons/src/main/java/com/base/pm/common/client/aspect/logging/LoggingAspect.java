package com.base.pm.common.client.aspect.logging;
...
public class LoggingAspect extends BaseAspect {
    ...
    @Around("@annotation(org.springframework.web.bind.annotation.RequestMapping) && !@annotation(com.base.pm.common.client.aspect.logging.SkipLogging)")
