package com.base.pm.common.client.base.aspect;

import com.base.pm.common.client.aspect.security.AuthorizedWithRoles;
import com.base.pm.common.client.aspect.security.PublicEndPoint;
import com.base.pm.common.client.base.dto.logging.LogDTO;
...
public class BaseAspect {
    ...
    protected boolean isAuthorizedWithRoles(ProceedingJoinPoint joinPoint){
        return ((MethodSignature) joinPoint.getSignature()).getMethod().isAnnotationPresent(AuthorizedWithRoles.class);
    }
